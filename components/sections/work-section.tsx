    ...
    >
      <div className="mx-auto w-full max-w-7xl">
        ...
        >
          ...
          <p className="font-mono text-[10px] text-foreground/60 md:text-base">/ Recent projects</p>
        </div>
  ...
  return (
    ...
    >
      <div className="flex items-baseline gap-3 md:gap-8">
        <span className="font-mono text-[10px] text-foreground/30 transition-colors group-hover:text-foreground/50 md:text-base">
          {project.number}
        </span>
        <div>
          {project.href ? (
            <a
              ...
              className="mb-0.5 inline-block font-sans text-lg font-light text-foreground underline-offset-4 transition-transform duration-300 hover:underline group-hover:translate-x-2 md:mb-1 md:text-3xl lg:text-4xl"
            >
              {project.title}
            </a>
          ) : (
            <h3 className="mb-0.5 font-sans text-lg font-light text-foreground transition-transform duration-300 group-hover:translate-x-2 md:mb-1 md:text-3xl lg:text-4xl">
              {project.title}
            </h3>
          )}
      ...
      <span className="font-mono text-[10px] text-foreground/30 md:text-sm">{project.year}</span>
    </div>
  )
}
