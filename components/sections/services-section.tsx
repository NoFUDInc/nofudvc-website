    ...
    >
      <div className="mx-auto w-full max-w-7xl">
        ...
        >
          ...
          <p className="font-mono text-sm text-foreground/60 md:text-base">/ We share our expertise and resources with select startups that meet our criteria for cash + equity or equity only basis.</p>
        </div>
